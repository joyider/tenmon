...
SOURCES = ['Ann', 'Mona', 'Lisa']
MESSAGE = '''{{"APITimestamp": "{}","Node" : "SE/BBAB/IL/ARA/ILOCK2","Severity" : {},"Summary" : "Testlarm som kommer tas bort","FirstOccurrence" : "2019-03-14T13:34:04","LastOccurrence" : "2019-03-14T13:34:04","Tally" : 1,"Acknowledged" : 0,"Serial" : {},"Source" : "{}","SuppressEscalate" : 0,"Bana" : "Botniabanan","IvarObjectID" : 6691036,"IvarSiteObjectID" : 2520504,"Agent" : "Automattest","TTNumber" : "","TTStatus" : ""}}'''
...
class Pub(multiprocessing.Process):
    ...
    def run(self):
        ...
        for i in range(self.max_count):
            time.sleep(random.randint(10, 800)/1000)
            msg = self.msg.format((datetime.today()).strftime("%Y-%m-%d %H:%M:%S"), random.randint(0,5), random.randint(1223,1229), SOURCES[random.randint(0,2)])
